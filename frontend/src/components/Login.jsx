...
const Login = () => {
  ...
  return (
    /* 🎯 PREMIUM SPLIT WRAPPER: Transforms your form into a dual-panel glass window dashboard */
    <div className="max-w-5xl w-full mx-auto grid grid-cols-1 md:grid-cols-12 overflow-hidden rounded-3xl border border-slate-200/70 bg-white shadow-2xl min-h-[620px]">
      {/* ================= LEFT SIDE: INFOGRAPHIC EXECUTIVE PANEL ================= */}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400 mt-0.5">
                  Evaluate systemic publication trends, research milestones, and
