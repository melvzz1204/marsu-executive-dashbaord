export default function Footer({ isDarkMode = false }) {
  return (
    <footer
      className={`mt-auto flex flex-col justify-between gap-2 border-t px-4 py-5 text-xs font-medium transition-colors duration-300 sm:flex-row sm:px-6 lg:px-12 lg:py-6 ${
        isDarkMode
